...
function addChartAxis(xAxis, yAxis) {
    ...
    svg.append("text")
        ...
        .attr("x", 0 - (windowInformation.height / 2))
        .attr("dy", "1em")
        .style("text-anchor", "middle")
        .transition()
        .delay(1500)
    ...
    map.on("viewreset", function () {
        nodes.attr("transform",
            function (d) {
                ...
                var y = map.latLngToLayerPoint(new L.LatLng(d.lat, d.lng)).y - windowInformation.margin.top;
                return "translate(" +
                    x + "," +
                    y + ")";
            })
...
function addLegend() {
    ...
    d3.select("#divLegend")
        .append("svg")
        .attr("id", "svgLegend")
        .style("height", windowInformation.height + "px")
        .append("g")
        .attr("class", "legend")
...
function legendFiscalite(g) {
    ...
    var color = d3.interpolateRgb(colorBrewer.firstColor, colorBrewer.lastColor),
        max = 5;
    var dat = [];
...
function ColorBrewer() {
    ...
    this.colors = colorbrewer.Greens[9];
    this.firstColor = colorbrewer.Greens[9][0];
    this.lastColor = colorbrewer.Greens[9][8];
}
